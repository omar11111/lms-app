...
use App\Factories\CourseFactory\Products\SelfPacedProduct;

class SelfPacedCourseCreator extends CourseFactory
{
    public function supports(string $type): bool
    {
        return $type === CourseType::SelfPaced->value;
    }

    protected function createCreator(): CourseCreatorInterface
    {
        return new SelfPacedProduct;
    }
}
